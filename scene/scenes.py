...
from scene.component import Scene
...
class MenuScreen(Scene):
    def __init__(self):
        ...
        self.top_rectangle = genc.Surface(game_loader.DisplaySurf.WIDTH/2, 150, game_loader.DisplaySurf.WIDTH - 150, 200, (249, 209, 81))
        ...
        self.some_rectangle = genc.Surface(game_loader.DisplaySurf.WIDTH/2, 470, 270, 300)
        self.pointer = genc.ImageAnimation(game_loader.Gallery.POINTER, self.some_rectangle.rect.centerx + 250, self.some_rectangle.rect.centery, 0.1)
