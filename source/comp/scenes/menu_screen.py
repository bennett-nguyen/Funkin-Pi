...
class MenuScreen(Scene):
    def __init__(self):
        ...
        self.track_chooser_rect = Surface(
            const.HALF_WIDTH, 470, 270, 300)
        self.pointer = ImageAnimation(
            assets.Gallery.POINTER, self.track_chooser_rect.rect.centerx + 250, self.track_chooser_rect.rect.centery, 0.1)
